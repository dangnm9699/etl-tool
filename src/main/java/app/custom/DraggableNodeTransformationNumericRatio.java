...
public class DraggableNodeTransformationNumericRatio extends DraggableNodeTransformation {
    private ConfigureTransformationNumeric config;

    public DraggableNodeTransformationNumericRatio() {
        super();

        this.dragIconType = DragIconType.transformation_numeric_ratio;
    ...
    public void setupConfigHandler() {
        eConfigClicked = e -> {
            ...
            try {
                ...
                stage.setTitle("Transformation | Numeric Ratio");
