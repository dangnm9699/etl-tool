...
public class DraggableNodeTransformationNumericScale extends DraggableNodeTransformation {
    private ConfigureTransformationNumeric config;

    public DraggableNodeTransformationNumericScale() {
        super();
    ...
    public void setupConfigHandler() {
        eConfigClicked = e -> {
            ...
            try {
                ...
                stage.setTitle("Transformation | Numeric Scale");
